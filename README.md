...
This project uses Sentinel-2 NIR (band 8) classification of water and non-water pixels. the pipeline continues to calculate the flooded acreage within flooding units. lastly, the code bundles analytics into a parameterized report with spatial and tabular data.
