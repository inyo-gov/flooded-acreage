...
<!-- HTML iframe to embed a specific report --> <iframe src="docs/reports/bwma_flood_report_2025-06-04_0.1.html" width="100%" height="800px" style="border: none;" id="report-frame"></iframe> 
...
monthly_avg %>% ggplot(aes(x = month_date, y = avg_acres, fill = Flood_Unit)) +
  ...
  scale_x_date(
    limits      = as.Date(c("2024-08-01", "2025-07-01")),
    date_breaks = "1 month",
