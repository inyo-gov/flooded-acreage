...
csv_dir <- "docs/docs/reports/csv_output"
...
<!-- HTML iframe to embed a specific report --> <iframe src="docs/reports/bwma_flood_report_2025-08-02_0.1.html" width="100%" height="800px" style="border: none;" id="report-frame"></iframe> 
...
# 3b. Compute average flooded acres per (Flood_Unit × month_date)
...
monthly_avg %>% ggplot(aes(x = month_date, y = avg_acres, fill = Flood_Unit)) +
  ...
  scale_x_date(
    limits      = as.Date(c("2024-08-01", "2025-09-01")), # update monthly
    date_breaks = "1 month",
    date_labels = "%b '%y"   # e.g. "Sep '24", "Oct '24", … "Jun '25"
  ) +
  labs(
