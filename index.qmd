...
# 4a. Point to your folder of report HTMLs for scanning
#     Use docs/reports for scanning during render, but links use "reports" for GitHub Pages
report_scan_dir <- "docs/reports"
report_link_dir <- "reports"
...
<!-- HTML iframe to embed a specific report --> <iframe src="reports/bwma_flood_report_2025-12-01_0.16.html" width="100%" height="1000px" style="border: none;" id="report-frame"></iframe>
